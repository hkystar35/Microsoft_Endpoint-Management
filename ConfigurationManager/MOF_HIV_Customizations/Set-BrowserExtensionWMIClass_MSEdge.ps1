...
TRY{
  ...
  Function CreateClass{
    ...
    $NewClass.Qualifiers.Add("Description","$($Class) stores information on extensions added to browser.")
  ...
  $ProfilePath | ForEach-Object{
    ...
    If(Test-Path ($_.profileimagepath + "\AppData\Local\Microsoft\Edge\User Data\Default\Extensions")){
      $ChromeProfileFolder = Get-ChildItem ($_.profileimagepath + "\AppData\Local\Microsoft\Edge\User Data\Default\Extensions") | ? { $_.PSIsContainer}

...
FUNCTION Show-CYOA_Form_psf {
  ...
  KiP5fDy84n88Eyd9nEzx/j82+E1dXJ0LAgAAAABJRU5ErkJggg==')
	...
	[void]$combobox1.Items.Add('01')
	[void]$combobox1.Items.Add('02')
	[void]$combobox1.Items.Add('03')
	[void]$combobox1.Items.Add('04')
	[void]$combobox1.Items.Add('05')
	[void]$combobox1.Items.Add('06')
	[void]$combobox1.Items.Add('07')
	[void]$combobox1.Items.Add('08')
	[void]$combobox1.Items.Add('09')
	[void]$combobox1.Items.Add('10')
	[void]$combobox1.Items.Add('11')
	[void]$combobox1.Items.Add('12')
	[void]$combobox1.Items.Add('13')
	[void]$combobox1.Items.Add('14')
	[void]$combobox1.Items.Add('15')
	[void]$combobox1.Items.Add('16')
	[void]$combobox1.Items.Add('17')
	[void]$combobox1.Items.Add('18')
	[void]$combobox1.Items.Add('19')
	[void]$combobox1.Items.Add('20')
	[void]$combobox1.Items.Add('21')
	[void]$combobox1.Items.Add('22')
	[void]$combobox1.Items.Add('23')
	...
	$buttonReschedule.Add_Click({
			$Output.UpgradeNow = 'No'; $Output.DeferDate = Get-Date -Date $datetimepicker1.Value -Hour $combobox1.SelectedItem -Minute $combobox2.SelectedItem -Second '00' -Format 'yyyy-MM-dd HH:mm:ss'
		})
	$buttonReschedule.Visible = $False
	#
	# buttonLetsDoThis

...
Try {
	...
	[string]$appName = '7-Zip 17.01'
	[string]$appVersion = '17.01.00.0'
	[string]$appMSIProductCode = '{23170F69-40C1-2702-1701-000001000000}'
	[string]$appProcessesString = '7zFM,7zG' # comma-separated, but all inside sigle quote, like 'chrome,firefox,iexplore'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Execute-MSI -Action Install -Path '7z1701-x64.msi'

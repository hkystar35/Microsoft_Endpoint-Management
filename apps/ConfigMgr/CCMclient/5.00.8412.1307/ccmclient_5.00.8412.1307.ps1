...
Try {
	...
	[string]$appVersion = '5.00.8412.1000'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '06/14/2017'
	...
	If ($deploymentType -ine 'Uninstall') {
        ...
        Execute-Process -Path "$dirFiles\client\ccmsetup.exe" -Parameters 'SMSCACHESIZE=10000 SMSSITECODE=PAY' -WaitForMsiExec
        ...
        Do {
            ...
            If (!($status)) {
                Write-Log -Message "Waiting for $FileCheck file." -Severity 1 -Source $deployAppScriptFriendlyName

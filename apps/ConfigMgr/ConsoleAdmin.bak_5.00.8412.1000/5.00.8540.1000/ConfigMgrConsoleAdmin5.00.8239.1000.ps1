...
Try {
	...
	[string]$appVersion = '5.00.8239.1000'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	...
	$checkApps = "Microsoft.ConfigurationManagement","reportviewer"
    $runningApps = 0
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'Microsoft.ConfigurationManagement,reportviewer' -AllowDefer -DeferTimes 3 -CheckDiskSpace -PersistPrompt
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'Microsoft.ConfigurationManagement,reportviewer' -CloseAppsCountdown 300
		...
		Execute-MSI -Action Uninstall -Path '{7952AC6D-315A-4791-BDE3-0976D6E0AD72}'
		Remove-MSIApplications -Name 'System Center Configuration Manager Console'

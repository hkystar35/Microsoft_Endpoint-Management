...
Try {
	...
	[string]$appName = 'System Center Configuration Manager Cmdlet Library'
	[string]$appVersion = '5.00.8373.1189'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Execute-MSI -Action Install -Path 'ConfigMgr2012PowerShellCmdlets.msi'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		#Show-InstallationWelcome -CloseApps '' -CloseAppsCountdown 300
		...
		Execute-MSI -Action Uninstall -Path '{AD4433C8-FDC7-41A2-8777-BFB94A029986}'
        Remove-MSIApplications -Name 'System Center Configuration Manager Cmdlet Library'

...
Try {
	...
	[string]$appName = 'ConfigMgr 2012 Toolkit R2'
	[string]$appVersion = '5.00.7958.1151'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '07/07/2017'
	...
	$checkApps = "CliSpy","CMTrace","DeploymentMonitoringTool","PolicySpy","powervwr","SendSchedule","WakeupSpy","CEViewer","ContentLibraryExplorer","ContentLibraryTransfer","ContentOwnershipTool","DPJobMgr","RBAViewer","runmetersumm"
    $runningApps = 0
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'CliSpy,CMTrace,DeploymentMonitoringTool,PolicySpy,powervwr,SendSchedule,WakeupSpy,CEViewer,ContentLibraryExplorer,ContentLibraryTransfer,ContentOwnershipTool,DPJobMgr,RBAViewer,runmetersumm' -AllowDefer -DeferTimes 3 -CheckDiskSpace -PersistPrompt
		...
		Execute-MSI -Action Install -Path 'ConfigMgrTools.msi'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'CliSpy,CMTrace,DeploymentMonitoringTool,PolicySpy,powervwr,SendSchedule,WakeupSpy,CEViewer,ContentLibraryExplorer,ContentLibraryTransfer,ContentOwnershipTool,DPJobMgr,RBAViewer,runmetersumm' -CloseAppsCountdown 300
		...
		Execute-MSI -Action Uninstall -Path '{4FFF7ECC-CCF7-4530-B938-E7812BB91186}'
		Remove-MSIApplications -Name 'ConfigMgr 2012 Toolkit R2'

...
Try {
	...
	[string]$appName = 'WSUS server regkey change to SCCM'
	[string]$appVersion = '1'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '09/15/2017'
	...
	If ($deploymentType -ine 'Uninstall') {
        ...
        Execute-Process -Path "$envSystem32Directory\reg.exe" -Parameters "$dirFiles\SCCM-WSUS-regkey.reg"

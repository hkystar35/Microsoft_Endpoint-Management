...
Try {
	...
	[string]$appName = 'TortoiseSVN'
	[string]$appVersion = '1.10.1.28295'
	[string]$appMSIProductCode = $false #''
	[string]$appProcessesString = 'TortoiseIDiff,TortoiseMerge,TortoiseProc,TSVNCache' # comma-separated, but all inside sigle quote, like 'chrome,firefox,iexplore'
	[string]$appServicesString = $false #'' # comma-separated, but all inside sigle quote, like 'zoom,ccmexec,spotify'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '10/11/2018'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		SWITCH ($Is64Bit) {
			True{
				$InstallFileName = 'TortoiseSVN-1.10.1.28295-x64-svn-1.10.2.msi'
				# {84878EE6-526C-4C28-85DE-C5A7126D1639}
				$Bitness = '64-bit'
			}
			False{
				$InstallFileName = 'TortoiseSVN-1.10.1.28295-win32-svn-1.10.2.msi'
				# {CB5FAFE0-4E63-4E99-A9EE-818115AF6159}
				$Bitness = '32-bit'
			}
		}

...
Try {
	...
	[string]$appVendor = 'Agency Matters'
	[string]$appName = 'ANTS'
	[string]$appVersion = '01.01.0001'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'ants' -AllowDefer -DeferTimes 3 -CheckDiskSpace -PersistPrompt
		...
		Execute-MSI -Action Install -Path 'ANTSSetup.MSI'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'ants' -CloseAppsCountdown 300
		...
		Execute-MSI -Action Install -Path '{0E0985D2-3C02-4AD5-AAFF-BC2579654F15}'

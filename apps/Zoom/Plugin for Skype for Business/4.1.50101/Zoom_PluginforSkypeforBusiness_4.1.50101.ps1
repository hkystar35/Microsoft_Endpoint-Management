...
Try {
	...
	[string]$appName = 'Zoom Skype for Business Plugin'
	[string]$appVersion = '4.1.50101'
	[string]$appMSIProductCode = '{2E20108C-9D65-4672-B2E6-29C446259AFC}'
	[string]$appProcessesString = 'lync' # comma-separated, but all inside sigle quote, like 'chrome,firefox,iexplore'
	[string]$appServicesString = '' # comma-separated, but all inside sigle quote, like 'zoom,ccmexec,spotify'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '06/02/2018'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Execute-MSI -Action Install -Path 'ZoomLyncPluginSetup.msi'

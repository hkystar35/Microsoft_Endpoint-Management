...
Try {
	...
	[string]$appName = 'Zoom'
	[string]$appVersion = '4.1.25010'
	[string]$appMSIProductCode = '{DCA67722-210F-4C89-B342-2EA1B0B18545}'
	[string]$appProcessesString = 'zoom' # comma-separated, but all inside sigle quote, like 'chrome,firefox,iexplore'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Execute-MSI -Action Install -Path 'ZoomInstallerFull.msi'

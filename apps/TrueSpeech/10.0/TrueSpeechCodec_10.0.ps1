...
Try {
	...
	[string]$appVendor = 'TrueSpeech'
	[string]$appName = 'Codec'
	[string]$appVersion = '1.0'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '12/05/2017'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		#Execute-MSI -Action Install -Path 'truespeech.msi'
		$CopyFiles = 'tsd32.dll', 'tssoft32.acm'
		$CopyFiles | ForEach-Object {
			Copy-File -Path "$dirFiles\$_" -Destination "$envWinDir\SysWOW64"
			Set-RegistryKey -Key 'HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\SharedDlls' -Name "C:\WINDOWS\system32\$_" -Value '00000001' -Type 'DWord'
		}
		Set-RegistryKey -Key 'HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\Microsoft\Windows NT\CurrentVersion\Drivers32' -Name 'msacm.trspch' -Value 'tssoft32.acm' -Type 'String'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		#Execute-MSI -Action Uninstall -Path '{A9A77F11-8B44-47FF-9601-FB8EBC9A216A}'

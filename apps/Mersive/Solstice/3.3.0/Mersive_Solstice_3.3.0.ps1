...
Try {
	...
	[string]$appVersion = '3.3.0.10371'
	[string]$appMSIProductCode = '{a530b969-e51e-4c0e-b2f8-61f1b1ef636b}'
	...
	[string]$appScriptDate = '06/14/2018'
  ...
  If ($deploymentType -ine 'Uninstall') {
	...
	Execute-MSI -Action Install -Path 'SolsticeClient-3.3.0.msi' -Transform "$dirFiles\solstice.mst" -AddParameters "INSTALLDIR=`"$GoodInstallDirectory`""

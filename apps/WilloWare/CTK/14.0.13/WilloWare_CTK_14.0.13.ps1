...
Try {
	...
	[string]$appVendor = 'WilloWare'
	[string]$appName = 'Consulting Toolkit'
	[string]$appVersion = '14.0.13'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		# Copy files instead?
		#SA account for GP in keypass
		$Dynamcis = Get-InstalledApplication -Name "Microsoft Dynamics GP 2015"
		IF ($Dynamcis.InstallLocation -and (Test-Path -Path "$Dynamcis.InstallLocation" -PathType Container)) {
			New-Folder -Path $Dynamcis.InstallLocation\
			$envProgramFilesX86\Microsoft Dynamics\GP2015\Documentation                                True
			$envProgramFilesX86\Microsoft Dynamics\GP2015\4600W.CNK                                   False
			$envProgramFilesX86\Microsoft Dynamics\GP2015\4600W.DIC                                   False
			$envProgramFilesX86\Microsoft Dynamics\GP2015\Documentation\ConsultingToolkit.chm         False
			$envProgramFilesX86\Microsoft Dynamics\GP2015\Documentation\ConsultingToolkit.pdf         False
		}
		##*===============================================
		##* POST-INSTALLATION
		##*===============================================

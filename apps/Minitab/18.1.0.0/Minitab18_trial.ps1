...
Try {
	...
	[string]$appVendor = 'Minitab, Inc.'
	[string]$appName = 'Minitab'
	[string]$appVersion = '18.1.0.0'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '06/19/2017'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'mtb,borrow' -AllowDefer -DeferTimes 3 -CheckDiskSpace -PersistPrompt
		
		## Show Progress Message (with the default message)
		#Show-InstallationProgress
		
		## <Perform Pre-Installation tasks here>
		Remove-MSIApplications -Name 'Minitab'
		...
		#Execute-Process -Path 'minitab18.1.0.0setup.exe' -Parameters "/exenoui /qn ACCEPT_EULA=1 LICENSE_SERVER=Int-Minitab-01 DISABLE_ANALYTICS=1 DISABLE_UPDATES=1 /L*V `"$configToolkitLogDir\$appName-$appversion.log`""
		Execute-Process -Path 'minitab18.1.0.0setup.exe' -Parameters "/exenoui /qn ACCEPT_EULA=1 /L*V `"$configToolkitLogDir\$appName-$appversion.log`""
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'mtb,borrow' -CheckDiskSpace -PersistPrompt -BlockExecution
		...
		Execute-MSI -Action Uninstall -Path '{8D24BFA4-1266-436F-9EBF-F83F5CFADD2E}'
		Remove-MSIApplications -Name 'Minitab'
		Execute-MSI -Action Uninstall -Path '{F4DA0EDD-E9AC-4808-8B64-8FD33C51BD0F}'
        Remove-MSIApplications -Name 'Intel(R) Visual Fortran Redistributables on IA-32'
		##*===============================================
		##* POST-UNINSTALLATION
		##*===============================================

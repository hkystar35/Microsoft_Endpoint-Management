...
Try {
	...
	[string]$appVendor = 'Adapt Telephony Services LLC'
	[string]$appName = 'Adapt - Interaction Desktop - Agent Automated Status Changer'
	[string]$appVersion = '1.0.0.0'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '11/22/2017'
	...
	$checkApps = "InteractionClient","InteractionFax","InteractionVoicemail","InteractionVoicemailLauncherU","SIPSoftPhone","ScreenCaptureClientU"
    $runningApps = 0
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'InteractionClient,InteractionFax,InteractionVoicemail,InteractionVoicemailLauncherU,SIPSoftPhone,ScreenCaptureClientU' -AllowDefer -DeferTimes 3 -CheckDiskSpace -PersistPrompt
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'InteractionClient,InteractionFax,InteractionVoicemail,InteractionVoicemailLauncherU,SIPSoftPhone,ScreenCaptureClientU' -CloseAppsCountdown 300

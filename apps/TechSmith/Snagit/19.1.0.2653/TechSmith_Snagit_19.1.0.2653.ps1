...
Try {
	...
	[string]$appName = 'Snagit 2019'
	[string]$appVersion = '19.1.0.2653'
	[string]$appMSIProductCode = '{01FE8DFA-275C-432A-B272-C53F27A1CAAD}'
	[string]$appProcessesString = 'snagit,Snagit32,SnagitEditor' # comma-separated, but all inside sigle quote, like 'chrome,firefox,iexplore'
	[string]$appServicesString = $false #'' # comma-separated, but all inside sigle quote, like 'zoom,ccmexec,spotify'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '002/12/2019'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		# Remove previous versions #Don't remove this, Snagit MSI does not remove previous versions
		...
		Execute-MSI -Action Install -Path 'snagit.msi' -Transform 'snagit.mst'

...
Try {
	...
	[string]$appVendor = 'TechSmith Corporation'
	[string]$appName = 'Snagit 13'
	[string]$appVersion = '13.1.4'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '11/07/2017'
	...
	$checkApps = "snagit","Snagit32","SnagitEditor"
    $runningApps = 0
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'snagit,Snagit32,SnagitEditor' -AllowDefer -DeferTimes 3 -CheckDiskSpace -PersistPrompt
		
		## <Perform Pre-Installation tasks here>
		Remove-MSIApplications -Name 'Snagit'
		...
		Execute-MSI -Action Install -Path 'snagit_13.1.4.msi' -Transform 'snagit_13.1.4.mst'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'snagit,Snagit32,SnagitEditor' -CloseAppsCountdown 300
		...
		Remove-MSIApplications -Name 'Snagit'
        Execute-MSI -Action Uninstall -Path '{EB843DBC-704F-42BB-9FC1-A271A3683C89}'

...
Try {
	...
	[string]$appName = 'Snagit 2018'
	[string]$appVersion = '18.0.0'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '11/08/2017'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Execute-MSI -Action Install -Path 'snagit_18.0.0.msi' -Transform 'snagit_18.0.0.mst'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Remove-MSIApplications -Name 'Snagit'
        Execute-MSI -Action Uninstall -Path '{4B41B2EC-8221-46AE-A787-AE8737506065}'

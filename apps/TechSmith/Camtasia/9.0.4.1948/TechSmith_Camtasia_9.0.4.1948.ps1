...
Try {
	...
	[string]$appName = 'Camtasia 9'
	[string]$appVersion = '9.0.4.1948'
	[string]$appMSIProductCode = '{B8A4CB7E-7F5B-484F-A127-E4431000EDCE}'
	[string]$appProcessesString = 'CamRecorder,CamtasiaStudio,CamRecorder,CamtasiaStudio' # comma-separated, but all inside sigle quote, like 'chrome,firefox,iexplore'
	[string]$appServicesString = '' # comma-separated, but all inside sigle quote, like 'zoom,ccmexec,spotify'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '03/27/2018'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Execute-MSI -Action Install -Path 'camtasia.msi' -Transform 'camtasia.mst'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Remove-MSIApplications -Name 'Camtasia'

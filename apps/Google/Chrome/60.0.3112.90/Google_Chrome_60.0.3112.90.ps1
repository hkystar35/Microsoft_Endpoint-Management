...
Try {
	...
	[string]$appVersion = '60.0.3112.90'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '08/08/2017'
	...
	If ($deploymentType -ine 'Uninstall') {
        ...
        # MSI version - 66.255.49238
        #Add/Remove version - 60.0.3112.90
		...
		Execute-Process -path "$envSystem32Directory\reg.exe" -Parameters "import `"$dirSupportFiles\chromesettings.reg`""
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'chrome' -CloseAppsCountdown 300
        ...
        Execute-MSI -Action Uninstall -Path '{98305915-759E-39B2-A385-5818CDBB9F5B}'
        Remove-MSIApplications -Name 'Google Chrome'

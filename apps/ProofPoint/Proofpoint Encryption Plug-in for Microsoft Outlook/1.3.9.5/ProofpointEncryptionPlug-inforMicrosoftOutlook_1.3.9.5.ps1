...
Try {
	...
	[string]$appVendor = 'Proofpoint'
	[string]$appName = 'Proofpoint Encryption Plug-in for Microsoft Outlook'
	[string]$appVersion = '1.3.9.5'
	[string]$appMSIProductCode = '{A55A72C2-F761-4776-A665-556D5FDA5512}' #<--x64 same  #x86-->'{A55A72C2-F761-4776-A665-556D5FDA5512}'
	...
	[string]$appPublicDownloadURL = 'https://help.proofpoint.com/Proofpoint_Essentials/user_topics/Email_Encryption/Proofpoint_Essentials_Email_Encryption_Plug-in_for_Outlook#encrypt01'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '04/23/2019'
		...
		IF ($OfficeInfo) {
			...
			FOREACH ($App IN $OfficeInfo) {
				...
				IF ($App.Bitness) {
					...
					$MSIName = "PE_Plugin_Outlook_1.3.9.5_$($Bitness).msi"
					Execute-MSI -Path $MSIName
				}
			}
		}
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Remove-MSIApplications -Name 'Proofpoint'

Function Log-Start{
  ...
  Process{
    ...
    Write-Debug "***************************************************************************************************"
    Write-Debug "Started processing at [$(Get-Date -Format G)]."
    Write-Debug "***************************************************************************************************"
    Write-Debug ""
...
Function Log-Write{
  ...
  Process{
    ...
    Add-Content -Path $LogPath -Value "$($date) `t $($LineValue)"
  
    #Write to screen for debug mode
    Write-Debug "$($date) `t $($LineValue)"
  }
}
...
Function Log-Error{
  ...
  Process{
    $date = Get-Date -Format G
    Add-Content -Path $LogPath -Value "$($date) `t Error: An error has occurred [$ErrorDesc]."
  
    #Write to screen for debug mode
    Write-Debug "$($date) `t Error: An error has occurred [$ErrorDesc]."
...
.EXAMPLE
  ...
  Process{
    ...
    Add-Content -Path $LogPath -Value "***************************************************************************************************"
    Add-Content -Path $LogPath -Value "Finished processing at [$(Get-Date -Format G)]."
    Add-Content -Path $LogPath -Value "***************************************************************************************************"

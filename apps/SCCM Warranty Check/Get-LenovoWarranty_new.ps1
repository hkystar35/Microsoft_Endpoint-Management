...
$WarrantyURL1 = 'http://supportapi.lenovo.com/v2.5/warranty'
$WarrantyURL2 = '?Serial='
$WarrantyURL = $WarrantyURL1
#'http://supportapi.lenovo.com/v2.5/warranty?Serial='
Log-Write -LogPath $logFullPath -LineValue "Opening the web site URL $WarrantyURL"

$test = Invoke-WebRequest -uri $WarrantyURL -SessionVariable ln
...
$answer = Invoke-WebRequest -Uri ("http://supportapi.lenovo.com" + $form.Action) -WebSession $ln -Method $form.Method -Body $form.Fields

...
Try {
	...
	[string]$appName = 'Microsoft Visual C++ 2013 Redistributable'
	[string]$appVersion = '12.0.40660.0'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	...
	##*===============================================
	<## Code - when running interactive, check whether process is running. If not, then change to silent
	...
	If ($deploymentType -ine 'Uninstall') {
        ...
        ## Install mode forced to Silent
        Execute-Process -Path 'vcredist_x64.exe' -Parameters '/install /quiet /norestart'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		#Attempting to run regular uninstall, 32bit then 64bit
        Execute-Process -Path "C:\ProgramData\Package Cache\{323dad84-0974-4d90-a1c1-e006c7fdbb7d}\VC_redist.x64.exe" -Parameters '/uninstall /quiet'
        ...
        Execute-MSI -Action 'Uninstall' -Path '{323dad84-0974-4d90-a1c1-e006c7fdbb7d}'

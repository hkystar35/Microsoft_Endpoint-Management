...
Try {
	...
	[string]$appVersion = '4.0.21'
	[string]$appMSIProductCode = '{E8FA8815-3817-4128-A814-E2EAC456ADF0}'
	[string]$appProcessesString = 'PaintDotNet' # comma-separated, but all inside sigle quote, like 'chrome,firefox,iexplore'
	[string]$appServicesString = '' # comma-separated, but all inside sigle quote, like 'zoom,ccmexec,spotify'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '03/13/2018'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Execute-MSI -Action Install -Path 'PaintDotNet_x64.msi'
		...
		Remove-DesktopShortcut -N 'paint.net' -WC

...
Try {
	...
	[string]$appName = 'Microsoft Office Configuration Analyzer Tool 2.2'
	[string]$appVersion = '2.2.6018.801'
	[string]$appMSIProductCode = '{EA5C0F11-00CA-0321-0801-141002021782}'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Execute-MSI -Action Install -Path 'OffCAT.msi'

...
Try {
	...
	[string]$appName = 'Python 3.6.6'
	[string]$appVersion = '3.6.6150.0'
	...
	[string]$appScriptDate = '07/24/2018'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		# Uninstall 3.7.x
		$Pythons = Get-InstalledApplication -Name python
		$Uninstall = $Pythons | Where-Object {([System.Version]$_.DisplayVersion -gt '3.6.9') -and ([System.Version]$_.DisplayVersion -lt '3.8')}
		...
		# Download link for python 3.6.6
		#https://www.python.org/ftp/python/3.6.6/python-3.6.6-amd64.exe
		
		# Set Execution policy to RemoteSigned
		#Set-ExecutionPolicy -ExecutionPolicy RemoteSigned -Scope CurrentUser -Force
		$InstallDir = "$env:HOMEDRIVE\Python36"
		Execute-Process -Path 'python-3.6.6-amd64.exe' -Parameters "/quiet TargetDir=$InstallDir PrependPath=1 DefaultCustomTargetDir=$InstallDir /L*v `"$configToolkitLogDir\$($appName)_$($appVersion)_$($installPhase).log`""
		# /log `"$configToolkitLogDir\$($appName)_$($appVersion)_$($installPhase).log`"
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		# Uninstall 3.6.6
		$Pythons = Get-InstalledApplication -Name python
		$Uninstall = $Pythons | Where-Object {
			([System.Version]$_.DisplayVersion -ge '3.6.6') -and ([System.Version]$_.DisplayVersion -lt '3.7')
		}

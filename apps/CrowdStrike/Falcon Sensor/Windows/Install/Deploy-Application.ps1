...
Try {
	...
	[string]$appVendor = 'CrowdStrike, Inc.'
	[string]$appName = 'CrowdStrike Windows Sensor'
	[string]$appVersion = ''
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		#CDS_Win_Client.exe /install /quiet /norestart PW="P0w3r$h3ll" CID=EAB76DCAACA0449699CD250152E61357-D4
		#{D62D18A3-E141-42C2-BCDF-CD19FE286CA0}  CrowdStrike Device Control   4.17.8056.0
		#{6BEBAB1F-2C39-4D8F-AFA6-81363A1134D0}  CrowdStrike Sensor Platform  5.10.9106.0
		Execute-Process -Path 'WindowsSensor.exe' -Parameters '/install /quiet /norestart PW="P0w3r$h3ll" CID=EAB76DCAACA0449699CD250152E61357-D4'-SecureParameters
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		#If offline, run this with maint token for individual machines
		#$MainToken = ''
		#Execute-Process -Path 'CsUninstallTool.exe' -Parameters "MAINTENANCE_TOKEN=$($MainToken) /quiet" -SecureParameters

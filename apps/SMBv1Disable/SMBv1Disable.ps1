...
Try {
	...
	[string]$appScriptDate = '07/10/2017'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Execute-Process -Path "$envSystem32Directory\reg.exe" -Parameters "EXPORT "
		...
		Execute-Process -Path "$envSystem32Directory\reg.exe" -Parameters "import $dirFiles\DisableSMBv1.reg"
		...
		Show-InstallationRestartPrompt -CountdownNoHideSecond 600

...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Set-ActiveSetup -StubExePath "$envWinDir\system32\reg.exe" -Arguments 'ADD "HKCU\Software\Microsoft\Internet Explorer\MINIE" /f /v LinksBandEnabled /t REG_SZ /d 1' -Description 'EnableFavoritesBar' -Key 'PCTYEnableFavBar' -ContinueOnError $true
		#Set-ItemProperty -Path 'HKCU\Software\Microsoft\Internet Explorer\MINIE' -Name LinksBandEnabled -Value 1 -Force
		##*===============================================
		##* POST-INSTALLATION
		##*===============================================

...
Try {
	...
	[string]$appVersion = '2.2.150.0'
	[string]$appMSIProductCode = '{B5AAA51A-9119-44B4-AAB9-9A839AB783CC}'
	[string]$appProcessesString = $false #'UmbrellaDiagnostic,ERCService,ERCInterface' # comma-separated, but all inside sigle quote, like 'chrome,firefox,iexplore'
	[string]$appServicesString = $false #'' # comma-separated, but all inside sigle quote, like 'zoom,ccmexec,spotify'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '02/27/2019'

...
Try {
	...
	[string]$appVendor = 'F5 Networks'
	[string]$appName = 'BIG-IP Component Installer'
	[string]$appVersion = '71.2018.0417.2013'
	[string]$appMSIProductCode = '{A0BFE07E-3ED6-49D6-9B37-C14926246B7A}'
	...
	[string]$appScriptDate = '02/21/2019'

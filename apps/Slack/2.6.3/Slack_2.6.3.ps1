...
Try {
	...
	[string]$appVendor = 'Slack'
	[string]$appName = 'Slack Machine-Wide Installer'
	[string]$appVersion = '2.6.3'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '07/05/2017'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'slack' -AllowDefer -DeferTimes 3 -CheckDiskSpace -PersistPrompt
		...
		Execute-MSI -Action Install -Path 'SlackSetup.msi'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		3Show-InstallationWelcome -CloseApps 'slack' -CloseAppsCountdown 300
		...
		Execute-MSI -Action Uninstall -Path '{9314726B-9BC1-43E7-AC5D-490EE278F88C}'

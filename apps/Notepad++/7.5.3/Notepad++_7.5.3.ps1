...
Try {
	...
	[string]$appVersion = '7.5.3'
	[string]$appMSIProductCode = ''
	[string]$appProcessesString = 'Notepad++' # comma-separated, but all inside sigle quote, like 'chrome,firefox,iexplore'
	...
	#Function Uninstall-NotepadPlusPlus
        <#
	.SYNOPSIS
		A brief description of the Uninstall-MozMaintSvc function.
...
#>
	function Uninstall-NotepadPlusPlus {
		...
		Remove-MSIApplications -Name "Notepad++"
		$UninstallPaths = "Notepad++\uninstall.exe"
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Execute-Process -Path 'npp.7.5.3.Installer.exe' -Parameters '/S'

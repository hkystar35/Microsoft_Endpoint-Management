...
Try {
	...
	[string]$appName = 'IC Business Manager Applications 2017 R1'
	[string]$appVersion = '17.1.8.24'
	[string]$appMSIProductCode = '{E74534BF-A38F-4C61-8ED8-80E2D08DE496}'
	[string]$appProcessesString = 'ICBusinessManager,IFaxCovrU' # comma-separated, but all inside sigle quote, like 'chrome,firefox,iexplore'
	[string]$appServicesString = '' # comma-separated, but all inside sigle quote, like 'zoom,ccmexec,spotify'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '03/19/2018'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Execute-MSI -Action Install -Path 'ICBusinessManagerApps_2017_R1.msi' -Patch 'ICBusinessManagerApps_2017_R1_Patch8.msp'

...
Try {
	...
	[string]$appVendor = 'Trend Micro Inc.'
	[string]$appName = 'Trend Micro OfficeScan Agent'
	[string]$appVersion = '12.0.4345'
	[string]$appMSIProductCode = '{9E6FC684-EB43-4E85-B092-1D0D34C1BA4A}'
	...
	[string]$appScriptDate = '05/24/2018'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Execute-MSI -Path 'officescan-4480.msi' -Action Install
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Execute-MSI -Path "$appMSIProductCode" -Action Uninstall
